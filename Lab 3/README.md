...
Through our testing and Wizard-of-Oz sessions, we identified several areas where Nudge’s design could be improved to make interactions feel smoother, more natural, and less frustrating. One of the biggest issues was with wording and feedback. The device’s responses were often short and robotic — for example, replying with “Reminder added” instead of a friendlier, more human acknowledgment like “Okay, I’ve set that reminder for 7 p.m.”. Users also found the default error message, “Didn’t catch that,” to be unhelpful. They wanted the system to guide them toward the correct phrasing, such as “Did you mean to set a reminder or check one?” or “Can you repeat just the time?” These small wording changes can make the system feel more conversational and intuitive.

Timing was another area that caused confusion. There was a noticeable delay between when the user finished speaking and when Nudge responded. This led people to talk over the system or think it wasn’t listening. We realized that simple auditory or visual feedback — such as a soft “hmm” sound or a blinking LED while processing — could help users understand when the device is listening or thinking. In addition, users wanted more flexibility in how they set reminders. Instead of only specifying an exact time, people often said things like “later today” or “in 20 minutes.” Adding more natural timing options would make the experience more aligned with everyday language.

We also noticed issues with anticipation of misunderstandings. Many users said things like “Remind me about Mom,” expecting the system to infer that they meant “Call Mom.” Because the current version relied heavily on keyword matching, it often failed to interpret intent correctly. This caused frustration when users felt they were “speaking normally” but the device didn’t understand. We plan to add fuzzy matching and intent detection to make Nudge better at interpreting partial or ambiguous phrases. Finally, users wanted acknowledgment after completing a task — a simple confirmation like “Got it, I’ve marked that as done” helps maintain a sense of closure and trust.

2. What are other modes of interaction _beyond speech_ that you might also use to clarify how to interact?
While Nudge is primarily voice-driven, we realized that speech alone is not always sufficient for clarity. Adding multimodal interaction can help users understand the device’s state and intentions without needing to ask. For instance, an LED ring could visually indicate different modes — blue for listening, yellow for processing, and green for success. This gives immediate, glanceable feedback, especially in noisy environments where speech output might be missed. Similarly, subtle haptic feedback could signal when a reminder has been saved or when there’s an error. A short vibration could mean success, while a longer one could mean the system needs clarification.

We also envision using a small display or e-ink screen to show transcriptions or upcoming reminders. This helps users confirm that their request was understood correctly and allows them to edit or cancel reminders visually. For accessibility and convenience, gesture input could offer silent control — for example, waving to dismiss a reminder or tapping the device to repeat what was said. Finally, a mobile companion app or web interface could provide a visual overview of reminders, allowing users to check or modify them quickly. Together, these additional modalities make the system more transparent, flexible, and inclusive.
3. Make a new storyboard, diagram and/or script based on these reflections.
In our redesigned version, Nudge v2, the goal is to make the device feel more responsive, human, and multimodal. The first scene opens with the device in idle mode. A soft pulsing blue LED indicates that Nudge is listening for a wake word. When the user says, “Nudge, remind me to call Mom at 7 p.m.,” the device responds, “Got it — I’ll remind you to call Mom tonight at 7,” accompanied by a quick green flash to confirm success. This small combination of speech and light feedback provides both reassurance and efficiency.
