...
"""
Quick test script for NeoPixel LED ring
Run with: sudo python3 test_leds.py
"""
...
try:
    ...
    print("ERROR: NeoPixel library not installed!")
    print("Install with: sudo pip3 install rpi_ws281x adafruit-circuitpython-neopixel")
    sys.exit(1)
...
def test_connection():
    ...
    try:
        ...
        print()
        print("Troubleshooting tips:")
        print("1. Make sure you're running with sudo: sudo python3 test_leds.py")
        print("2. Check your wiring:")
        print("   - 5V  → Pin 4")
        print("   - GND → Pin 6")
        print("   - DIN → Pin 12 (GPIO 18)")
        print("3. Try a different GND pin (e.g., Pin 14)")
        print("4. Verify the NeoPixel ring is the 24-LED version")
        sys.exit(1)
...
if __name__ == "__main__":
    if os.geteuid() != 0:
        ...
        print("=" * 60)
        print()
        print("Run with: sudo python3 test_leds.py")
        print()
        sys.exit(1)
